...
public class OumeiListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_OUMEILIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_OUMEILIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadoumeiList(handler, WhatConstants.GET_OUMEILIST_SUCCESS,WhatConstants.GET_OUMEILIST_FAIL);
