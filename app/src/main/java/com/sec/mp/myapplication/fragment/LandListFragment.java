...
public class LandListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_LANDLIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_LANDLIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadlandList(handler, WhatConstants.GET_LANDLIST_SUCCESS,WhatConstants.GET_LANDLIST_FAIL);
