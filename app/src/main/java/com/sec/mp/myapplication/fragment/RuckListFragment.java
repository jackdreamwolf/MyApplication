...
public class RuckListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_RUCKLIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_RUCKLIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadruckList(handler, WhatConstants.GET_RUCKLIST_SUCCESS,WhatConstants.GET_RUCKLIST_FAIL);
