...
public class MeiZuListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_MINZULIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_MINZULIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadminyaoList(handler, WhatConstants.GET_MINZULIST_SUCCESS,WhatConstants.GET_MINZULIST_FAIL);
