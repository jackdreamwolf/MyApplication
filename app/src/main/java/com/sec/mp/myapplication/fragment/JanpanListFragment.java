...
public class JanpanListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_JAPANLIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_JAPANLIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadjanpenList(handler, WhatConstants.GET_JAPANLIST_SUCCESS,WhatConstants.GET_JAPANLIST_FAIL);
