...
public class HanguoListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_HANGUOLIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_HANGUOLIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadhanguoList(handler, WhatConstants.GET_HANGUOLIST_SUCCESS,WhatConstants.GET_HANGUOLIST_FAIL);
