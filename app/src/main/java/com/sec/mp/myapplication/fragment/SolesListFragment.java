...
public class SolesListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_SLOELIST_SUCCESS:
                ...
                break;
            case WhatConstants.GET_SLOELIST_FAIL:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadSloeList(handler, WhatConstants.GET_SLOELIST_SUCCESS,WhatConstants.GET_SLOELIST_FAIL);
