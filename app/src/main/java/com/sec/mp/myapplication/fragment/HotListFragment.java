...
public class HotListFragment extends BaseFragment implements HotListAdapter.OnItemClickLitener{
    ...
    protected void handler(Message msg) {
        switch (msg.what){
            case WhatConstants.GET_HOTLIST_SUCCESS:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        model.LoadHotList(handler,WhatConstants.GET_HOTLIST_SUCCESS,WhatConstants.GET_HOTLIST_FAIL);
